                    ...
                    <div class="footer-widget footer-widget--contact">
                        ...
                        <ul class="list-unstyled footer-widget__info">
                            <li> <span class="icon-location"></span>
                                <address>Luwero, Ssambwe, Kiyana Village. Off Bombo Rd, Ndejje University Rd</address>
                            </li>
                            <li> <span class="icon-phone"></span><a href="tel:(406)555-0120">(256)759834655</a></li>
                            <li> <span class="icon-envelope"></span><a href="mailto:info@nambiorphanagecentre.org">info@nambiorphanagecentre.org</a></li>
                        </ul><!-- /.list-unstyled -->
                    </div><!-- /.footer-widget -->
                ...
                <div class="col-md-3 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="400ms">
                    <div class="footer-widget footer-widget--links">
                        ...
                        <ul class="list-unstyled footer-widget__links">
                            ...
                            <li><a href="/donate-right">Give Donation</a></li>
        ...
        <div class="container">
            <div class="main-footer__bottom__inner">
                <p class="main-footer__copyright">
                    &copy; Copyright <span class="dynamic-year"></span> Nambi Orphanage Centre All Rights Reserved.
                </p>
    ...
    <div class="mobile-nav__content">
        ...
        <ul class="mobile-nav__contact list-unstyled">
            <li>
                ...
                <a href="mailto:info@nambiorphanagecentre.org">info@nambiorphanagecentre.org</a>
            </li>
            <li>
                <i class="fa fa-phone-alt"></i>
                <a href="tel:(256)759834655">(256) 759834655</a>
            </li>
...
<div class="search-popup">
    ...
    <div class="search-popup__content">
        <form role="search" method="get" class="search-popup__form" action="index#">
...
<aside class="sidebar-one">
    ...
    <div class="sidebar-one__content">
        ...
        <div class="sidebar-one__about sidebar-one__item">
            <p class="sidebar-one__about__text">Nambi Oprhanage Centre</p>
            ...
            <ul class="sidebar-one__information__list">
                <li>
                    ...
                    <address class="sidebar-one__information__address">
                        <p class="sidebar-one__information__text">Luwero, Ssambwe, Kiyana Village. Off Bombo Rd, Ndejje University Rd</p>
                    </address>
                </li>
                <li>
                    <i class="sidebar-one__information__icon icon-envelope"></i>
                    <p class="sidebar-one__information__text"><a href="mailto:info@nambiorphanagecentre.org">info@nambiorphanagecentre.org</a></p>
                </li>
                <li>
                    <span class="sidebar-one__information__icon icon-phone"></span>
                    <p class="sidebar-one__information__text"><a href="tel:(256)759834655">(256) 0759834655</a></p>
                </li>
            </ul>
        ...
        <div class="sidebar-one__newsletter sidebar-one__item">
            ...
            <form action="index#" class="sidebar-one__newsletter__inner mc-form" data-url="MAILCHIMP_FORM_URL">
